...
// ------------------------ admin后台管理 ------------------------
// 创建文章
export const postArticleCreate = (data: any) => {
  return HttpClient.post(ApiConstants.POST_ARTICLE_CREATE, data)
}
// 更新文章
export const postArticleUpdate = (data: any) => {
  return HttpClient.post(ApiConstants.POST_ARTICLE_UPDATE, data)
}
// 删除文章
export const deleteArticle = (params: any) => {
  return HttpClient.delete(ApiConstants.delete_article, params)
}
// 获取注册用户列表
...
export const deleteUser = (params: any) => {
  return HttpClient.delete(ApiConstants.DELETE_USER, params)
}
